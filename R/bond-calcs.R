...
#'
#' @examples
Vasicek1fPrice <- function(r, a, b, s, t){
...
#'
#' @examples
Vasicek2fPrice <- function(r1, r2, a1, a2, s1, s2, u, t){
...
#'
#' @examples
Vasicek2fYield <- function(r1, r2, a1, a2, s1, s2, u, t){

  p <- Vasicek2fPrice(r1, r2, a1, a2, s1, s2, u, t)
